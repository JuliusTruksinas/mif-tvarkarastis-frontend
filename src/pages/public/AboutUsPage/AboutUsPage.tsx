    ...
    <div className={styles.aboutUsPage}>
      <div className={styles.pageInnerContent}>
        ...
        <p className={styles.pageSubtitle}>
          View information about Bug busters
        </p>
        <div className={styles.personImgCardsContainer}>
          <label className="swap swap-flip">
            <input type="checkbox" />
            <div className="swap-on">
              <img src={JuliusC} alt="User Avatar" />
              <div className={styles.description}>
                <p className={styles.name}>Julius</p>
                <p className={styles.inputLabel}>
                  Suvalgau tiek mėsos, kad kažkur pasaulyje 5 veganai nedaro
                  jokio skirtumo.
                </p>
              </div>
            </div>
            <div className="swap-off">
              <img src={Julius} alt="User Avatar" />
              <div className={styles.description}>
                <p className={styles.name}>Julius</p>
          ...
          <label className="swap swap-flip">
            <input type="checkbox" />
            <div className="swap-on">
              <img src={LivetaC} alt="User Avatar" />
              <div className={styles.description}>
            ...
            <div className="swap-off">
              <img src={Liveta} alt="User Avatar" />
              <div className={styles.description}>
                <p className={styles.name}>Liveta</p>
          ...
          <label className="swap swap-flip">
            <input type="checkbox" />
            <div className="swap-on">
              <img src={NikaC} alt="User Avatar" />
              <div className={styles.description}>
                <p className={styles.name}>Nika</p>
                <p className={styles.inputLabel}>
                  Turiu juodą karate diržą, todėl namuose valgyti gamins ir
                  namus tvarkys vyras.
                </p>
              </div>
            </div>
            <div className="swap-off">
              <img src={Nika} alt="User Avatar" />
              <div className={styles.description}>
                <p className={styles.name}>Nika</p>
                <p className={styles.inputLabel}>Web Design and Front-end</p>
              </div>
          ...
          <label className="swap swap-flip">
            <input type="checkbox" />
            <div className="swap-on">
              <img src={NojusC} alt="User Avatar" />
              <div className={styles.description}>
          ...
          <label className="swap swap-flip">
            <input type="checkbox" />
            <div className="swap-on">
              <img src={GustavasC} alt="User Avatar" />
              <div className={styles.description}>
            ...
            <div className="swap-off">
              <img src={Gustavas} alt="User Avatar" />
              <div className={styles.description}>
                <p className={styles.name}>Gustavas</p>
                <p className={styles.inputLabel}>Back-end</p>
              </div>
          ...
          <label className="swap swap-flip">
            <input type="checkbox" />
            <div className="swap-on">
              <img src={BugBusterC} alt="User Avatar" />
              <div className={styles.description}>
            ...
            <div className="swap-off">
              <img src={BugBuster} alt="User Avatar" />
              <div className={styles.description}>
                <p className={styles.name}>Bug Buster’is</p>
